...
int main(int argc, char *argv[])
{
     ...
     */
     ...
     // Initialization of the constructor, three ways:
     /*
    ...
    // Class to pointer
    // What is the pointer?
    // Pointer: It is a kind of variable that stores the memory of created variables.
    /*
    scalar a = 3.0;
    scalar * p;
    p=&a; // &-> The address of a.
    Info<<"The address of a: "<<p<<endl;
    Info<<"The address of a: "<< &a << endl;
    Info<<"The pointer p has value: "<<*p<<endl;

     */
    //*p => It signifies that it is pointed to a variable
